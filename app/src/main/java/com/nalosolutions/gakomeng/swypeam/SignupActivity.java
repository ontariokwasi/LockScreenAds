...
public class SignupActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    String []networks = new String[]{"MTN","TIGO","AIRTEL","VODAFONE"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner ntwks = (Spinner) findViewById(R.id.network);
        ...
        countryCodePicker.registerCarrierNumberEditText(mEmailView);
